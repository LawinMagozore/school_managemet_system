          ...
          <div class="card-body">
            <form action="" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <input type="text" name="name" placeholder="Course Name" required class="form-control text-black">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="duration" placeholder="Course Duration" required class="form-control text-black" class="text-black">
              </div>
              <div class="form-group">
